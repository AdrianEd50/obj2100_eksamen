...
public class Visning {
    ...
    @Column(name = "v_visningsnr")
    private int visningsNr;

    @Column(name = "f_filmnr", nullable = false)
    private Integer filmNr;

    @Column(name = "k_kinosalnr", nullable = false)
    ...
    @Column(name = "v_slutttid", nullable = false)
    ...
    // Gettere og settere (bare gettere her for enkelhet)
    public int getVisningNr() { return visningsNr; }
    public int getFilmNr() { return filmNr; }
    public int getKinosalNr() { return kinosalNr; }
    public LocalDate getDato() { return dato; }
    public LocalTime getStarttid() { return starttid; }
    public LocalTime getSlutttid() { return slutttid; }
